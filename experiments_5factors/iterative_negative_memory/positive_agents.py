...
def _build_ultra_strict_prompt(
    ...
    middle_factors: List[Dict[str, Any]],
    negatives: List[Dict[str, Any]],
    n: int,
    round_id: int,
) -> str:
    """
    超严格版 Prompt - 分层展示（Top / Middle / Negative）
    100% 强制 np.where，禁止 (denom + 1e-8)
    """
    def _fmt(rec: Dict[str, Any], i: int) -> str:
    ...
    # ========== Top block ========== #
    top_block = "\n".join(_fmt(r, i + 1) for i, r in enumerate(top_factors))

    # ========== Middle block ========== #
    mid_block = ""
    if middle_factors:
        mid_lines = "\n".join(_fmt(r, i + 1) for i, r in enumerate(middle_factors))
        mid_block = f"""
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    📊 MIDDLE-TIER FACTORS (MODERATE PERFORMANCE - FOR REFERENCE)
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

    {mid_lines}

    These factors have MODERATE train scores. They use valid structure
    but their financial logic is less effective than the top tier.
    Use them as reference — understand the gap between top and middle.
    """

    # ========== Negative block ========== #
    neg_block = ""
    if negatives:
        neg_lines = "\n".join(_fmt(r, i + 1) for i, r in enumerate(negatives))
        neg_block = f"""
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ✅ TOP PERFORMING FACTORS (COPY THEIR STRUCTURE — HIGHEST TRAIN SCORES)
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
class PositiveAgents:
    ...
    def generate_factors(
        ...
        **kwargs
        ...
        top_factors = [r for r in memory_records if r.get("tier") == "top"]
        middle_factors = [r for r in memory_records if r.get("tier") == "middle"]
