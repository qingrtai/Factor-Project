# experiments/iterative_negative_memory_with_reports_v2/run_negative_report.py
"""
...
# 导入本实验模块
from experiments_5factors.iterative_negative_memory_with_reports_v2.config import (
    CONFIG,
    MAX_ROUNDS,
    validate_config,
    print_config_summary,
)
from experiments_5factors.iterative_negative_memory_with_reports_v2.iterator import FactorIterator
...
def main():
    ...
    logger = setup_logger(
        name="iterative_negative_memory_with_reports_v2",
        level="INFO",
